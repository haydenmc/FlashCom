...
namespace
{
    constexpr std::wstring_view c_windowClass{ L"FlashComTrayIconWindowClass" };
    ...
    ATOM CreateWindowClass(const std::wstring& className, WNDPROC wndProc, HINSTANCE hInstance)
    {
        ...
        windowClass.cbWndExtra = sizeof(FlashCom::View::TrayIcon*);
    ...
    HWND CreateWindowInstance(FlashCom::View::TrayIcon* instancePointer,
